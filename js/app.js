  ...
  static renderMeds(allMeds) {
    ...
    if (UI.activeTab === "all") {
      allMeds.forEach((med) => {
		...
		liRow.append(renderedProductName, renderedProductType, renderedManufacturer, renderedExpirationDate, renderedQuantity, deleteButtonContainer);
